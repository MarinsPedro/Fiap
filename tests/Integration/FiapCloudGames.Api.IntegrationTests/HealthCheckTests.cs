...
public sealed class FiapCloudGamesApiFactory : WebApplicationFactory<Program>
{
    public FiapCloudGamesApiFactory()
    {
        ...
        Environment.SetEnvironmentVariable("Jwt__Issuer", "FiapCloudGames.Tests");
        Environment.SetEnvironmentVariable("Jwt__Audience", "FiapCloudGames.Tests");
    }
